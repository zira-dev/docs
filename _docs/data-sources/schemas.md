...
there are 2 options,
   1. manipulating the existing value - example: "x*10+5", in this case x will be replaced with the received value{% include image.html noBorder="true" img="calculatedFieldExampleWIthConf.png" lightbox="true" alt="Hamburger menu" caption="data-sources-context" %}  
